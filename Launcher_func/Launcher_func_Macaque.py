...
sys.path.append('/srv/projects/easymribrain/code/EasyMRI_brain-master')
...
bids_dir = Tools.Load_subject_with_BIDS.linux_path(opj('/scratch/cgarin/Macaque/BIDS_BenHamed'))
...
BASE_SS = opj(atlas_dir, 'template.nii.gz')
