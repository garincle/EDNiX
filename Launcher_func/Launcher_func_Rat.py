...
### Then you can explore your dataset
...
removelist = []
# 300301 ==> 300309 problem img header, aquisition not in z...
# '300600' ==> 300609 problem img header, aquisition not in z...
# 300805 problem
...
lower_cutoff = 0.3 # int
upper_cutoff = 0.8 # int
