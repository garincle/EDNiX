...
bids_dir = Tools.Load_subject_with_BIDS.linux_path(opj('/scratch/cgarin/'+ species + '/BIDS_Gd'))
...
selected_atlases = ['atlaslvl4_LR.nii.gz']  # Changed to match NEW VERSION format
panda_files = [pd.DataFrame({'region':['retrosplenial'],'label':[162]})]  # Changed to match NEW VERSION format
