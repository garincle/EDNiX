...
def Refimg_to_meanfMRI(anat_func_same_space, type_norm, Ref_file, volumes_dir, BASE_SS_coregistr, TfMRI, masks_dir, dir_fMRI_Refth_RS_prepro1, dir_fMRI_Refth_RS_prepro2, 
    dir_fMRI_Refth_RS_prepro3, RS, nb_run, recordings, REF_int, ID, TR, dir_prepro, n_for_ANTS, brainmask_D, brainmask, V_mask, W_mask, dilate_mask, list_atlases, labels_dir, overwrite):
