...
bids_dir = opj('/scratch/cgarin/Chimpanzee/BIDS_Rilling')
species = 'Chimpanzee'
...
# Ask get() to return the ids of subjects that have T1 files
#T2 = layout.get(return_type='filename', target='subject', suffix='T1', extension='nii.gz')
#print(T2)
...
dir_out = '/scratch/cgarin/Chimpanzee/BIDS_Rilling/sty_template/atlases'
