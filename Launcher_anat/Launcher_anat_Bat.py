...
atlas_dir = opj('/srv/projects/easymribrain/data/Atlas/13_Atlas_project/Atlases_V2', species)
Lut_dir = opj(MAIN_PATH,'data','Atlas','13_Atlas_project','LUT_files')
...
list_atlases = [opj('/srv/projects/easymribrain/data/Atlas/13_Atlas_project/0_Atlas_modify/Atlas/Bat', 'atlas.nii.gz'),
                opj(atlas_dir, 'TTS.nii.gz'),
