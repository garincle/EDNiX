...
bids_dir = Tools.Load_subject_with_BIDS.linux_path(opj('/srv/projects/easymribrain/data/MRI/Macaque/ARITEP-PNH/BIDS_ready/'))
...
###masking
masking_img = 'T1w'
brain_skullstrip_1 ='3dSkullStrip_macaque' # bet2_ANTS or MachinL
#precise
brain_skullstrip_2 ='Manual' # bet2_ANTS or MachinL
do_fMRImasks = True
...
Skip_step = [1,2,3,4,10,11,12,13,14,15,16,100,200]
