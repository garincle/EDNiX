...
############# variables
out_analysis = '/srv/projects/easymribrain/scratch/Snake'
DICOMdir = '/home/common/benhalab/CASCAD/Snake/MRI/LIBUREL_someil_serpents/LIBUREL_someil_serpents'

in_DICOM = DICOMdir + '/S_SILAS/'
