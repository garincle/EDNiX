...
SPECIES_NAME     = 'Human'           # used in surface filenames
SPECIES_FRAGMENT = 'atlas/mammals/primates/Human'

# ── BIDS dataset ──────────────────────────────────────────────────────────────
BIDS_DIR = os.path.join('/scratch2/EDNiX/Human/ds004513-download')
...
TEMPLATE_LOW     = '/scratch2/EDNiX/Human/ds004513-download/sub-s025/ses-closed/func/templates/EDNiX/preprocessing/BASE_SS_fMRI.nii.gz'
...
from Exemples.Study_EDNiX.analysis.ednix_bids_tools import extract_bold_paths, parse_label_file, get_atlas_label_path
