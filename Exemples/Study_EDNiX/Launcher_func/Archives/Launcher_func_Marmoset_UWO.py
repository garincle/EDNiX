...
bids_dir = Tools.Load_subject_with_BIDS.linux_path(opj('/scratch/cgarin/'+ species + '/BIDS_UWO'))
...
Slice_timing_info = 'Auto'  # XXX - Using new version default since OLD VERSION had complex timing not directly transferable
...
use_master_for_Allineate  = False # True or False
