...
masking_img = '' # could be T1w or T2w (if left empty it will be set to "type_norm")
...
transfo_align_dict = {"name": 'align',
                              ...
                              "affmetric": '',              # should be "mattes" (means MI for mutual information),"GC" (global correlation) or "meansquare"
                              "affmetricT": ''              # should be "mattes" (means MI for mutual information),"GC" (global correlation) or "meansquare"
                              }

# coregistration between nT1 and T2 modalities
...
preftool                    = 'freeview'                 # 'freeview' or 'ITK'
