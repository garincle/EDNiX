...
analyses.Group_fMRI._Group_anal_3dLME_dvt_SBA._3dLME_dev_EDNiX(bids_dir, BASE_SS, oversample_map, mask_func, folder_atlases, xcell_extrernal_data, panda_files, selected_atlases,
                                                               lower_cutoff, upper_cutoff, MAIN_PATH, FS_dir, alpha, all_ID, all_Session, all_data_path, max_sessionlist, endfmri, mean_imgs)

analyses.Group_fMRI._Group_anal_3dLMEr_SBA._3dLMEr_EDNiX(bids_dir, BASE_SS, oversample_map, mask_func, folder_atlases, cut_coordsX, cut_coordsY, cut_coordsZ, panda_files, selected_atlases,
...
analyses.Group_fMRI._Group_anal_3dTtest._3dttest_EDNiX(bids_dir, BASE_SS, oversample_map, mask_func, folder_atlases, cut_coordsX, cut_coordsY, cut_coordsZ, panda_files, selected_atlases,
                                                       lower_cutoff, upper_cutoff, MAIN_PATH, FS_dir, alpha, all_ID, all_Session, all_data_path, max_sessionlist, endfmri, mean_imgs)

analyses.Group_fMRI._Group_anal__func_DicLearn.dicstat(BASE_SS, oversample_map, mask_func, folder_atlases, cut_coordsX, cut_coordsY, alpha_dic, component_list,
