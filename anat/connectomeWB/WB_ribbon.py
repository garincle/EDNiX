...
def set(dir_path,Ref_file,label_FS_all,animal,BALSAname,version,Hmin,RibbonValue,diary_name,sing_wb):
    ...
    img = create(Ref_file,label_FS_all,animal,dir_surf,dir_out,Surf_in,Surf_out,vol_out,Hmin,RibbonValue,diary_name,sing_wb)

    if version == 'native':
        layers(img, animal, dir_surf, labels_dir, masks_dir, Surf_in, Surf_out, Ref_file,diary_name, sing_wb)

def create(Ref_file,label_FS_all,animal,dir_surf,dir_out,Surf_in,Surf_out,vol_out,Hmin,RibbonValue,diary_name,sing_wb):
...
def layers(img1,animal,dir_surf,labels_dir, masks_dir,Surf_in,Surf_out,Ref_file,diary_name,sing_wb):
