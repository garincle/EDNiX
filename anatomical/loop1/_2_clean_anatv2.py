...
def clean_anat(Align_img_to_template, bids_dir, listTimage, list_transfo, ID, Session,
    ...
    if os.path.exists(BASE_SS_anat_res):
        ...
        nl = "We found already a template supposed to be in anat resolution, let's check that the resolution of your reference anatomical image (img 0 in the list of anat) has not change!!"
