...
from anatomical.loop3 import backtonative, _16_anat_QC_SNR, _100_Data_Clean, _200_Data_QC
from anatomical import transfo_T2toT1w
from anatomical.freesurfer import smallbrain, preFS, FS_surf, FS_finalise, FS_2_WB, FS_flat, FS_freeview
...
def run(all_ID, all_Session, all_data_path,ID, Session, data_path, max_ses,creat_study_template,study_template_atlas_folder,BASE_SS,BASE_mask,BASE_atlas_folder,
    ...
    for suffix_T in listTimage:
        if 'T1' in suffix_T:
            ...
            nl = 'T1 or T2 is not in suffix name of your BIDS anatomical images, this is a requirement for EDNiX!'
