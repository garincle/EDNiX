...
def White_create(FS_dir, monkey,s_bind,fs_sif, diary_file):

    ct = datetime.datetime.now()
    nl = 'Run anatomical._11_FS_1_white.White_create'
    ...
    for H in range(2):
        ...
        nl = 'INFO: ' + surface[H] + ' surface done!'
...
def White_more(FS_dir, monkey, FS_buckner40_TIF, FS_buckner40_GCS,s_bind,fs_sif, diary_file):

    ct = datetime.datetime.now()
    nl = 'Run anatomical._11_FS_1_white.White_more'
    diary = open(diary_file, "a")
    diary.write(f'\n{ct}')
    diary.write(f'\n{nl}')
