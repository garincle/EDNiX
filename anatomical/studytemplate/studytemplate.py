...
from anatomical.studytemplate import _3_make_template
from anatomical.studytemplate import _4_skullstrip_template
from anatomical.studytemplate import _7_stdyT_to_AtlasT
...
def use(study_template_atlas_folder,Skip_step,list_transfo, list_atlases,
    ...
    # average the available anatomical files
